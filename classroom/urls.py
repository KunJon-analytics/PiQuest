...
urlpatterns = [
    path('', classroom.class_index, name='home'),

    path('staff/', include(([
        path('', staff.dashboard, name='dashboard'),
        path('account/', staff.account, name='account'),
        #    path('account/change-password/',
        #         staff.ChangePassword.as_view(), name='change_password'),
        path('admin-accounts/', staff.AdminListView.as_view(), name='admin_list'),
        #    path('admin-accounts/add/',
        #         staff.AdminCreateView.as_view(), name='admin_add'),
        path('admin-accounts/<int:pk>/delete/',
             staff.deactivate_admin, name='admin_deactivate'),
        path('course-requests/', staff.CourseRequestsView.as_view(),
             name='course_requests'),
        path('course-requests/accept/<int:course_pk>/',
             staff.accept_course, name='accept_course'),
        path('course-requests/reject/<int:course_pk>/',
             staff.reject_course, name='reject_course'),
        path('courses/', staff.CourseListView.as_view(), name='course_list'),
        path('courses/<int:course_pk>/delete/',
             staff.delete_course, name='course_delete'),
        path('get-user-activities/', staff.get_user_activities,
             name='get_user_activities'),
        path('get-course-status/', staff.get_course_status,
             name='get_course_status'),
        path('students/', staff.StudentListView.as_view(), name='student_list'),
        path('students/<int:pk>/delete/',
             staff.deactivate_student, name='teacher_deactivate'),
    ...
    path('student/', include(([
        ...
        path('taken/<int:taken_pk>/quiz/<int:quiz_pk>/',
             students.taken_quiz_result, name='taken_quiz_detail'),
    ...
    path('teacher/', include(([
        ...
        path('ajax/load-lessons/', teachers.load_lessons,
             name='ajax_load_lessons'),
        #    path('change-password/', teachers.ChangePassword.as_view(),
        #         name='change_password'),
        path('course/add/', teachers.CourseCreateView.as_view(), name='course_add'),
        path('course/<int:pk>/', teachers.CourseUpdateView.as_view(),
             name='course_change'),
        path('course/<int:pk>/delete/',
             teachers.delete_course, name='course_delete'),
        ...
        path('quiz/<int:quiz_pk>/delete/',
             teachers.delete_quiz, name='quiz_delete'),
